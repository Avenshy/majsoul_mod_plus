        ...
        !function (t) {
            ...
            var i = function (i) {
                ...
                n.get_item_count = function (t) {
                    ...
                    if (100001 == t) {
                        for (var i = 0, n = 0, a = GameMgr.Inst.free_diamonds; n < a.length; n++) {
                            u = a[n];
                            GameMgr.Inst.account_numerical_resource[u] && (i += GameMgr.Inst.account_numerical_resource[u])
                        }
                        for (var r = 0, s = GameMgr.Inst.paid_diamonds; r < s.length; r++) {
                            u = s[r];
                            GameMgr.Inst.account_numerical_resource[u] && (i += GameMgr.Inst.account_numerical_resource[u])
                        }
                        return i
                    ...
                    if (100004 == t) {
                        for (var o = 0, l = 0, h = GameMgr.Inst.free_pifuquans; l < h.length; l++) {
                            u = h[l];
                            GameMgr.Inst.account_numerical_resource[u] && (o += GameMgr.Inst.account_numerical_resource[u])
                        }
                        for (var c = 0, _ = GameMgr.Inst.paid_pifuquans; c < _.length; c++) {
                            var u = _[c];
                            GameMgr.Inst.account_numerical_resource[u] && (o += GameMgr.Inst.account_numerical_resource[u])
                        }
                        return o
                ...
                n.get_item_daily_record = function (t, e) {
                    return this._daily_gain_record[t] && this._daily_gain_record[t].record_time && game.Tools.isPassedRefreshTimeServer(this._daily_gain_record[t].record_time) && this._daily_gain_record[t][e] ? this._daily_gain_record[t][e] : 0
                },
        ...
        !function (t) {
            ...
            i = function (i) {
                ...
                n.prototype.change_select = function (e) {
                    ...
                    "chs" == GameMgr.client_language && (200040 == i.charid || 200043 == i.charid ? this.label_name.font = "fengyu" : this.label_name.font = "hanyi"),
        ...
        !function (t) {
            var e = function () {
                ...
                e.prototype.render_character_cell = function (e) {
                    ...
                    s.getChildByName("label_name").text = cfg.item_definition.character.find(o.charid)["name_" + GameMgr.client_language],
                    a.getChildByName("btn").getChildByName("bg").skin = game.Tools.localUISrc("myres/sushe/bg_head" + (o.is_upgraded ? "2.png" : ".png")),
                    "en" == GameMgr.client_language || "jp" == GameMgr.client_language ? r.bound.skin = game.Tools.localUISrc("myres/sushe/en_head_bound" + (o.is_upgraded ? "2.png" : ".png")) : r.bound.skin = game.Tools.localUISrc("myres/sushe/bg_head" + (o.is_upgraded ? "4.png" : "3.png")),
                    r.btn_star.visible = this.select_index == n,
                    r.star.visible = t.UI_Sushe.is_char_star(o.charid) || this.select_index == n,
                    "chs" == GameMgr.client_language || "chs_t" == GameMgr.client_language ? r.star.skin = game.Tools.localUISrc("myres/sushe/tag_star_" + (t.UI_Sushe.is_char_star(o.charid) ? "l" : "d") + (o.is_upgraded ? "1.png" : ".png")) : r.star.skin = game.Tools.localUISrc("myres/sushe/tag_star_" + (t.UI_Sushe.is_char_star(o.charid) ? "l.png" : "d.png")),
                        ...
                        if (i.charid != t.UI_Sushe.main_character_id)
                            if (t.UI_PiPeiYuYue.Inst.enable)
                                ...
                                for (var a = 0; a < t.UI_Sushe.characters.length; a++)
                                    t.UI_Sushe.characters[a].charid == n && this.scrollview.wantToRefreshItem(a);
                ...
                e.prototype.onChangeStarShowBtnClick = function () {
                    if (0 != t.UI_Sushe.star_chars.length || this.only_show_star_char) {
                        ...
                        t.UI_SecondConfirm.Inst.show_only_confirm(game.Tools.strOfLocalization(3301))
                },
                e.prototype.getShowStarState = function () {
                    0 != t.UI_Sushe.star_chars.length ? this.only_show_star_char = "1" == Laya.LocalStorage.getItem("onlyShowStar") : this.only_show_star_char = !1
                },
                e.prototype.sortShowCharsList = function () {
                    ...
                    if (!this.only_show_star_char)
                        for (a = 0; a < t.UI_Sushe.characters.length; a++)
        ...
        !function (t) {
            ...
            a = function (a) {
                ...
                r.prototype.onPlayerChange = function (t) {
                    if (app.Log.log(t), !((t = t.toJSON()).seq && t.seq <= this.update_seq)) {
                        // 修改友人房间立绘
                ...
                i.prototype.setItemValue = function (t, e) {
                    ...
                    if (this.enable) {
                        ...
                        if (1 == r.unlock_type) {
                            ...
                            s.text = game.Tools.strOfLocalization(3121) + h["expire_desc_" + GameMgr.client_language],
                            s.visible = !0,
                            o.y = 0
                        } else
                            s.visible = !1, o.y = 10
            ...
            !function (e) {
                var i = function () {
                    ...
                    return i.prototype.show = function (e) {
                        ...
                        for (s = 0; s < t.UI_Sushe.characters.length; s++)
