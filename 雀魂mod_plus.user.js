...
for (var i = 0; i < ca.length; i++) {
    ...
    if (c.indexOf(charid) == 0) {
        ...
        console.log('[雀魂mod改]' + setcharacter)
    }
    if (c.indexOf(skin) == 0) {
                                    ...
                                    if (0 == c)
                                        ...
                                        for (var _ = 0; _ < n.players.length; _++)
                                            if (n.players[_].account_id == c) {
                                                a[h] = n.players[_];
                                                console.log("[雀魂mod改]n_id:" + a[h].account_id);
                                                console.log('[雀魂mod改]' + GameMgr.Inst.account_id);
                                                //修改牌桌上人物头像及皮肤
